...
class Cli {
    ...
    createTruck() {
        inquirer
            ...
            .then((answers) => {
            const truck = new Truck(Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.speed), [], parseInt(answers.towingCapacity));
